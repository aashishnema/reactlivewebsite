...
function HelloWorld() {
    return (
        ...
        <span className="bodyClass">
         ...
         <p>Education Guidelines (Typical):
Science / Engineering graduate

Purpose of the Role:
Design develop and implement tasks/components of a work package / project as per client requirements; create a zero defect code and modify complex systems or develop new sub systems; develop comprehensive unit testing cases and plans; update knowledge assets and guide team to do the same; integrate work of developers WITH THE OBJECTIVE OF delivering high quality project deliverables WITHIN THE LIMITS OF delivery timelines security quality and performance guidelines.
...
Project Estimation:
' Understand how the estimation (effort size etc.) is done at task level in the area of work concerned measure and report the actual effort against the estimated effort and ensure task progress reporting in C2.0 or any other applicable tool.
...
People management:
Engage with team; resolve / conflict management within team; conduct internal trainings for developers within team. "</p>
        </span>
